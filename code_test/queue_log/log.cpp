...
void log_init(int async_flag) {
  if (1 == async_flag)
    Log::get_instance()->init("./log_record/ServerLog", 0, 2000, 1100000, 800);
  else
    Log::get_instance()->init("./log_record/ServerLog", 0, 2000, 1100000, 0);
}
